...
config/spawn-setup/<project-dir-basename>  optional per-project executable that provisions a freshly allocated worktree before its worker launches; LOCAL, gitignored, absent means no-op, and NOT inherited by secondmate homes; see docs/configuration.md "Spawn setup hooks"
